...
if (!defined('WEBMAKERR_PLUGIN_PATH')) {
    ...
    define('WEBMAKERR_UPLOAD_DIR', defined('FLUENTCART_UPLOAD_DIR') ? FLUENTCART_UPLOAD_DIR : 'fluent_cart');
...
defined('FLUENTCART_UPLOAD_DIR') || define('FLUENTCART_UPLOAD_DIR', WEBMAKERR_UPLOAD_DIR);
