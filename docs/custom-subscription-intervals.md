...
Extend Webmakerr Cart's default subscription intervals with custom billing cycles.
...
**Note:** Only use this hook if you're using Webmakerr Cart's built-in gateways or third-party gateway addons. If you own the payment gateway code, handle the billing period directly in your gateway processor instead.
