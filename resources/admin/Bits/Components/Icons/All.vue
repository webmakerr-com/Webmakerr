<template>
  ...
  <path d="M4.25 11.75L4.25 8.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
  <path d="M8 11.75L8 4.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
  <path d="M11.75 11.75L11.75 7.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
