...
class EntityPopulator
{
    ...
    public function guessColumnFormatters(\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Generator $generator)
    {
        ...
        $columnTypeGuesser = new \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\ORM\Propel2\ColumnTypeGuesser($generator);
     ...
     * @return bool
     */
    protected function isColumnBehavior(\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Propel\Runtime\Map\ColumnMap $columnMap)
    {
        foreach ($columnMap->getTable()->getBehaviors() as $name => $params) {
            $columnName = \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Base::toLower($columnMap->getName());
            switch ($name) {
                case 'nested_set':
     ...
     * @return array
     */
    public function guessModifiers(\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Generator $generator)
    {
        $modifiers = [];
        $class = $this->class;
        $peerClass = $class::TABLE_MAP;
