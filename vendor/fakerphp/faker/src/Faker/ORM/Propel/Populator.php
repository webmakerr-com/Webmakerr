...
class Populator
{
    ...
    {
        if (!$entity instanceof \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\ORM\Propel\EntityPopulator) {
            $entity = new \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\ORM\Propel\EntityPopulator($entity);
        }
