 ...
 */
final class Color implements \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Extension\ColorExtension
{
     ...
     * @var string[]
     */
    private array $safeColorNames = ['black', 'maroon', 'green', 'navy', 'olive', 'purple', 'teal', 'lime', 'blue', 'silver', 'gray', 'yellow', 'fuchsia', 'aqua', 'white'];
    /**
     * @var string[]
     */
    ...
    {
        return \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Extension\Helper::randomElement($this->safeColorNames);
    }
    /**
     * @example 'NavajoWhite'
     */
    ...
    {
        return \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Extension\Helper::randomElement($this->allColorNames);
    }
    /**
     * @example '340,50,20'
     */
    ...
    {
        return [$this->numberExtension->numberBetween(0, 360), $this->numberExtension->numberBetween(0, 100), $this->numberExtension->numberBetween(0, 100)];
    }
}