...
class UserAgent extends \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Base
{
    ...
    public static function chrome()
    {
        ...
        $platforms = ['(' . static::linuxPlatformToken() . ") AppleWebKit/{$saf} (KHTML, like Gecko) Chrome/" . self::numberBetween(36, 40) . '.0.' . self::numberBetween(800, 899) . ".0 Mobile Safari/{$saf}", '(' . static::windowsPlatformToken() . ") AppleWebKit/{$saf} (KHTML, like Gecko) Chrome/" . self::numberBetween(36, 40) . '.0.' . self::numberBetween(800, 899) . ".0 Mobile Safari/{$saf}", '(' . static::macPlatformToken() . ") AppleWebKit/{$saf} (KHTML, like Gecko) Chrome/" . self::numberBetween(36, 40) . '.0.' . self::numberBetween(800, 899) . ".0 Mobile Safari/{$saf}"];
    ...
    public static function msedge()
    {
        ...
        $platforms = ['(' . static::windowsPlatformToken() . ") AppleWebKit/{$saf} (KHTML, like Gecko) Chrome/{$chrv}" . '.' . self::numberBetween(4000, 4844) . '.' . self::numberBetween(10, 99) . " Safari/{$saf} Edg/{$chrv}" . self::numberBetween(1000, 1146) . '.' . self::numberBetween(0, 99), '(' . static::macPlatformToken() . ") AppleWebKit/{$saf} (KHTML, like Gecko) Chrome/{$chrv}" . '.' . self::numberBetween(4000, 4844) . '.' . self::numberBetween(10, 99) . " Safari/{$saf} Edg/{$chrv}" . self::numberBetween(1000, 1146) . '.' . self::numberBetween(0, 99), '(' . static::linuxPlatformToken() . ") AppleWebKit/{$saf} (KHTML, like Gecko) Chrome/{$chrv}" . '.' . self::numberBetween(4000, 4844) . '.' . self::numberBetween(10, 99) . " Safari/{$saf} EdgA/{$chrv}" . self::numberBetween(1000, 1146) . '.' . self::numberBetween(0, 99), '(' . static::iosMobileToken() . ") AppleWebKit/{$saf} (KHTML, like Gecko) Version/15.0 EdgiOS/{$chrv}" . self::numberBetween(1000, 1146) . '.' . self::numberBetween(0, 99) . " Mobile/15E148 Safari/{$saf}"];
        return 'Mozilla/5.0 ' . static::randomElement($platforms);
    }
    /**
    ...
    public static function firefox()
    {
        ...
        $platforms = ['(' . static::windowsPlatformToken() . '; ' . static::randomElement(static::$lang) . '; rv:1.9.' . self::numberBetween(0, 2) . '.20) ' . $ver, '(' . static::linuxPlatformToken() . '; rv:' . self::numberBetween(5, 7) . '.0) ' . $ver, '(' . static::macPlatformToken() . ' rv:' . self::numberBetween(2, 6) . '.0) ' . $ver];
        return 'Mozilla/5.0 ' . static::randomElement($platforms);
    }
    /**
    ...
    public static function safari()
    {
        ...
        if (\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Miscellaneous::boolean()) {
        ...
        $platforms = ['(Windows; U; ' . static::windowsPlatformToken() . ") AppleWebKit/{$saf} (KHTML, like Gecko) Version/{$ver} Safari/{$saf}", '(' . static::macPlatformToken() . ' rv:' . self::numberBetween(2, 6) . '.0; ' . static::randomElement(static::$lang) . ") AppleWebKit/{$saf} (KHTML, like Gecko) Version/{$ver} Safari/{$saf}", '(' . static::randomElement($mobileDevices) . ' ' . self::numberBetween(7, 8) . '_' . self::numberBetween(0, 2) . '_' . self::numberBetween(1, 2) . ' like Mac OS X; ' . static::randomElement(static::$lang) . ") AppleWebKit/{$saf} (KHTML, like Gecko) Version/" . self::numberBetween(3, 4) . '.0.5 Mobile/8B' . self::numberBetween(111, 119) . " Safari/6{$saf}"];
        return 'Mozilla/5.0 ' . static::randomElement($platforms);
    }
    /**
    ...
    {
        $platforms = ['(' . static::linuxPlatformToken() . '; ' . static::randomElement(static::$lang) . ') Presto/2.' . self::numberBetween(8, 12) . '.' . self::numberBetween(160, 355) . ' Version/' . self::numberBetween(10, 12) . '.00', '(' . static::windowsPlatformToken() . '; ' . static::randomElement(static::$lang) . ') Presto/2.' . self::numberBetween(8, 12) . '.' . self::numberBetween(160, 355) . ' Version/' . self::numberBetween(10, 12) . '.00'];
