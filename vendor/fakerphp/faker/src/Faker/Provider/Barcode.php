 ...
 */
class Barcode extends \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Base
{
    private function ean($length = 13)
    {
        $code = static::numerify(str_repeat('#', $length - 1));
        return $code . \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Calculator\Ean::checksum($code);
    }
    /**
    ...
    {
        return \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Calculator\Ean::checksum($input);
    }
    /**
     * ISBN-10 check digit
     *
    ...
    {
        return \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Calculator\Isbn::checksum($input);
    }
    /**
    ...
    public function isbn10()
    {
        ...
        return $code . \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Calculator\Isbn::checksum($code);
    }
    /**
