...
namespace FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\ru_RU;
...
{
    protected static $maleNameFormats = ['{{firstNameMale}} {{middleNameMale}} {{lastNameMale}}', '{{lastNameMale}} {{firstNameMale}} {{middleNameMale}}'];
    /**
     ...
     */
    protected static $femaleNameFormats = ['{{firstNameFemale}} {{middleNameFemale}} {{lastNameFemale}}', '{{lastNameFemale}} {{firstNameFemale}} {{middleNameFemale}}'];
    /**
