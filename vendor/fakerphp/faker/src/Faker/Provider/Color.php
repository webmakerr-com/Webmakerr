...
class Color extends \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Base
{
    ...
    {
        return [self::numberBetween(0, 360), self::numberBetween(0, 100), self::numberBetween(0, 100)];
    }
}