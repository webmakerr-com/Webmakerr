...
class Person extends \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Person
{
    ...
    public function nir($gender = null, $formatted = false)
    {
        ...
        $nir .= $this->numerify('##') . sprintf('%02d', $this->numberBetween(1, 12));
        // Department
        $department = key(\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\fr_FR\Address::department());
        $nir .= $department;
