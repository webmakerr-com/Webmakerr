...
class Company extends \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Company
{
    ...
    public function siret($formatted = true)
    {
        ...
        $siret .= \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Calculator\Luhn::computeCheckDigit($siret);
        if ($formatted) {
    ...
    {
        $siren = self::numerify('%#######');
        $siren .= \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Calculator\Luhn::computeCheckDigit($siren);
        if ($formatted) {
