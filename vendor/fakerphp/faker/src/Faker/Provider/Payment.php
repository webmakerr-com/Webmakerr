...
use FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Calculator\Iban;
use FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Calculator\Luhn;
class Payment extends \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Base
{
    public static $expirationDateFormat = 'm/y';
    protected static $cardVendors = ['Visa', 'Visa', 'Visa', 'Visa', 'Visa', 'MasterCard', 'MasterCard', 'MasterCard', 'MasterCard', 'MasterCard', 'American Express', 'Discover Card', 'Visa Retired', 'JCB'];
    /**
    ...
    public static function creditCardNumber($type = null, $formatted = false, $separator = '-')
    {
        ...
        $number .= \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Calculator\Luhn::computeCheckDigit($number);
        if ($formatted) {
    ...
    public static function iban($countryCode = null, $prefix = '', $length = null)
    {
        ...
        foreach (str_split($expandedFormat) as $class) {
            switch ($class) {
                default:
                case 'c':
                    $result .= \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Miscellaneous::boolean() ? static::randomDigit() : strtoupper(static::randomLetter());
                    break;
                case 'a':
        ...
        $checksum = \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Calculator\Iban::checksum($countryCode . '00' . $result);
