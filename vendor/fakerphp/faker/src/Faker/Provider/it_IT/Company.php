...
class Company extends \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Company
{
    ...
    public static function vat()
    {
        ...
        return sprintf('IT%s%d', $code, \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Calculator\Luhn::computeCheckDigit($code));
    }
    /**
     * Italian VAT number (partita IVA)
     *
