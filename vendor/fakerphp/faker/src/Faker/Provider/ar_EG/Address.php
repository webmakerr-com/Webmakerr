...
{
    protected static $cityPrefix = ['شمال', 'جنوب', 'شرق', 'غرب'];
     ...
     */
    protected static $cityName = ['التجمع الاول', 'التجمع التالت', 'التجمع الخامس', 'الشروق', 'الرحاب', 'الجزيرة', 'الحسين', 'الزمالك', 'السلام', 'الظاهر', 'العباسية', 'المطرية', 'الموسكي', 'النزهة الجديدة', 'السيدة زينب', 'المرج', 'المعادي', 'المقطم', 'المنيل', 'الوايلي', 'باب الشعرية', 'باب اللوق', 'ثكنات المعادي', 'جاردن سيتي', 'جسر السويس', 'عابدين', 'حدائق المعادي', 'حلمية الزيتون', 'حلوان', 'الأزبكية', 'الزاوية الحمراء', 'الساحل', 'مدينة نصر', 'حدائق القبة', 'شبرا', 'عين شمس', 'روكسي', 'زهراء المعادي', 'سراي القبة', 'عبود', 'عزبة النخل', 'كوتسيكا', 'الشيخ زايد', 'السادس من اكتوير', 'العاشر من رمضان', 'المعصرة', 'الزهراء', 'غمرة', 'المنيب', 'فيصل', 'الدقي', 'العتبة', 'المظلات', 'المطار', 'قباء', 'ألف مسكن', 'هليوبوليس', 'هارون', 'كلية البنات', 'عبده باشا', 'الجيش', 'الكيت كات', 'إمبابة'];
    /**
     ...
     */
    protected static $governorates = ['الإسكندرية' => '02', 'الإسماعيلية' => '19', 'أسوان' => '28', 'أسيوط' => '25', 'الأقصر' => '29', 'البحر الأحمر' => '31', 'البحيرة' => '18', 'بني سويف' => '22', 'بورسعيد' => '03', 'جنوب سيناء' => '35', 'القاهرة' => '01', 'الدقهلية' => '12', 'دمياط' => '11', 'سوهاج' => '26', 'السويس' => '04', 'الشرقية' => '13', 'شمال سيناء' => '34', 'الغربية' => '16', 'الفيوم' => '23', 'القليوبية' => '14', 'قنا' => '27', 'كفر الشيخ' => '15', 'مطروح' => '33', 'المنوفية' => '17', 'المنيا' => '24', 'الوادي الجديد' => '32'];
