...
{
    protected static $formats = ['{{companyPrefix}} {{cityName}}', '{{companyPrefix}} {{lastName}}', '{{cityName}} {{companySuffix}}', '{{lastName}} {{companySuffix}}', '{{companyPrefix}} {{lastName}} {{companySuffix}}', '{{companyPrefix}} {{cityName}} {{companySuffix}}'];
    ...
    protected static $companySuffix = [' ش.م.م', ' للتجاره العامه', 'للأجهزة الطبيه', 'للتوريدات', 'للمقاولات', 'للتطوير العقاري', 'للدعايه و الاعلان', 'للحلول المتقدمه', 'للخدمات الدولية', 'الدولية', 'للانظمة المتكاملة'];
    /**
     * @example 'مؤسسة'
     *
     * @return string
    ...
    public static function companyTaxIdNumber()
    {
        ...
        return \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Calculator\Luhn::generateLuhnNumber($partialValue);
    }
    /**
     * example 010101
     */
