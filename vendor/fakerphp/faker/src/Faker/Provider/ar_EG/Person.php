...
class Person extends \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Person
{
    ...
    public static function nationalIdNumber($gender = null)
    {
        ...
        $governorateId = \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\ar_EG\Address::governorateId();
        $birthRegistrationSequence = mt_rand(1, 500);
        if ($gender === static::GENDER_MALE) {
            $birthRegistrationSequence = $birthRegistrationSequence | 1;
            // Convert to the nearest odd number
