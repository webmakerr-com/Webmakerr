...
namespace FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\de_DE;
...
class PhoneNumber extends \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\PhoneNumber
{
    ...
    protected static $e164Formats = ['+49{{areaCode}}#######'];
    /**
     * @see https://en.wikipedia.org/wiki/Toll-free_telephone_number
     */
    protected static $tollFreeAreaCodes = [800];
    ...
    protected static $mobileCodes = [1511, 1512, 1514, 1515, 1516, 1517, 1520, 1521, 1522, 1523, 1525, 1526, 1529, 1570, 1573, 1575, 1577, 1578, 1579, 1590];
    protected static $mobileFormats = ['+49{{mobileCode}}#######', '+49 {{mobileCode}} ### ####', '0{{mobileCode}}#######', '0{{mobileCode}} ### ####', '0 {{mobileCode}} ### ####'];
    /**
