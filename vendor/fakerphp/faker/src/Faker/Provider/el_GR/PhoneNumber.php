...
namespace FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\el_GR;
...
class PhoneNumber extends \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\PhoneNumber
{
    ...
    protected static $formats = ['{{fixedLineNumber}}', '{{mobileNumber}}', '{{personalNumber}}', '{{tollFreeNumber}}', '{{sharedCostNumber}}', '{{premiumRateNumber}}'];
    ...
    protected static $fixedLineFormats = ['{{internationalCodePrefix}}21########', '{{internationalCodePrefix}} 21# ### ####', '{{internationalCodePrefix}}{{areaCode}}######', '{{internationalCodePrefix}} {{areaCode}} ######'];
    protected static $mobileCodes = [685, 687, 688, 689, 690, 691, 693, 694, 695, 696, 697, 698, 699];
    protected static $mobileFormats = ['{{internationalCodePrefix}}{{mobileCode}}#######', '{{internationalCodePrefix}} {{mobileCode}} ### ####'];
    protected static $personalFormats = ['{{internationalCodePrefix}}70########', '{{internationalCodePrefix}} 70 #### ####'];
    protected static $tollFreeFormats = ['{{internationalCodePrefix}}800#######', '{{internationalCodePrefix}} 800 ### ####'];
    protected static $sharedCostCodes = [801, 806, 812, 825, 850, 875];
    protected static $sharedCostFormats = ['{{internationalCodePrefix}}{{sharedCostCode}}#######', '{{internationalCodePrefix}} {{sharedCostCode}} ### ####'];
    protected static $premiumRateCodes = [901, 909];
    protected static $premiumRateFormats = ['{{internationalCodePrefix}}{{premiumRateCode}}#######', '{{internationalCodePrefix}} {{premiumRateCode}} ### ####'];
    /**
    ...
    {
        return static::numerify(strtr(static::randomElement(static::$mobileFormats), ['{{internationalCodePrefix}}' => static::internationalCodePrefix(), '{{mobileCode}}' => static::mobileCode()]));
    }
    /**
    ...
    {
        return ltrim(static::numerify(strtr(static::randomElement(static::$tollFreeFormats), ['{{internationalCodePrefix}}' => static::internationalCodePrefix()])));
    }
    /**
