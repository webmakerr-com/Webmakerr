 ...
 */
class Image extends \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Base
{
    /**
     * @var string
     */
    ...
    {
        \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\trigger_deprecation('fakerphp/faker', '1.20', 'Provider is deprecated and will no longer be available in Faker 2. Please use a custom provider instead');
        ...
        if ($randomize === true) {
            $imageParts[] = \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Lorem::word();
        }
        $backgroundColor = $gray === true ? 'CCCCCC' : str_replace('#', '', \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Color::safeHexColor());
     ...
     * @return bool|string
     */
    public static function image($dir = null, $width = 640, $height = 480, $category = null, $fullPath = true, $randomize = true, $word = null, $gray = false, $format = 'png')
    {
        \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\trigger_deprecation('fakerphp/faker', '1.20', 'Provider is deprecated and will no longer be available in Faker 2. Please use a custom provider instead');
    ...
    {
        \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\trigger_deprecation('fakerphp/faker', '1.20', 'Provider is deprecated and will no longer be available in Faker 2. Please use a custom provider instead');
        return [static::FORMAT_JPG => constant('IMAGETYPE_JPEG'), static::FORMAT_JPEG => constant('IMAGETYPE_JPEG'), static::FORMAT_PNG => constant('IMAGETYPE_PNG')];
    }
}