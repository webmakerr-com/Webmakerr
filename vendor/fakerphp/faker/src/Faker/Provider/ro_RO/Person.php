...
namespace FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\ro_RO;
...
class Person extends \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Person
{
    ...
    {
        $genders = [\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\ro_RO\Person::GENDER_MALE, \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\ro_RO\Person::GENDER_FEMALE];
        if (empty($gender)) {
    ...
    protected function getDateOfBirth($dateOfBirth)
    {
        ...
        $baseDate = \FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\DateTime::dateTimeBetween("first day of January {$dateOfBirthParts[0]}", "last day of December {$dateOfBirthParts[0]}");
    ...
    protected static function getGenderDigit(\DateTime $dateOfBirth, $gender, $isResident)
    {
        ...
        if ($dateOfBirth->format('Y') < 1900) {
            if ($gender == \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\ro_RO\Person::GENDER_MALE) {
                return 3;
            }
            return 4;
        }
