...
use FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\DefaultGenerator;
use FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Generator;
use FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\UniqueGenerator;
use FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\ValidGenerator;
class Base
{
    /**
     * @var FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Generator
     */
    protected $generator;
    /**
     * @var FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\UniqueGenerator
     */
    protected $unique;
    ...
    {
        $elements = $array;
        if (is_string($array) && function_exists('enum_exists') && \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\FluentCart\FluentCart\FluentCart\FluentCart\enum_exists($array)) {
    ...
    public static function regexify($regex = '')
    {
        ...
        $regex = preg_replace_callback('/(\[[^\]]+\])\{(\d+),(\d+)\}/', static function ($matches) {
            return str_repeat($matches[1], \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Base::randomElement(range($matches[2], $matches[3])));
        }, $regex);
        ...
        $regex = preg_replace_callback('/\((.*?)\)/', static function ($matches) {
            return \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Base::randomElement(explode('|', str_replace(['(', ')'], '', $matches[1])));
        }, $regex);
        ...
        $regex = preg_replace_callback('/\[([^\]]+)\]/', static function ($matches) {
            ...
            $randomElement = \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Base::randomElement(str_split($match));
    ...
    public function optional($weight = 0.5, $default = null)
    {
        ...
        return new \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\DefaultGenerator($default);
    }
    /**
    ...
    public function unique($reset = false, $maxRetries = 10000)
    {
        if ($reset || !$this->unique) {
            $this->unique = new \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\UniqueGenerator($this->generator, $maxRetries);
        }
        return $this->unique;
    }
    /**
    ...
    {
        return new \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\ValidGenerator($this->generator, $validator, $maxRetries);
    }
}