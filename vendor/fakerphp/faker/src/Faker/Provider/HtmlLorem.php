...
class HtmlLorem extends \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Base
{
    ...
    public function __construct(\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Generator $generator)
    {
        ...
        $generator->addProvider(new \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Lorem($generator));
        $generator->addProvider(new \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Provider\Internet($generator));
    }
    /**
     * @param int $maxDepth
     * @param int $maxWidth
    ...
    public function randomHtml($maxDepth = 4, $maxWidth = 4)
    {
        ...
        $this->idGenerator = new \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\UniqueGenerator($this->generator);
