...
class Luhn
{
    ...
    public static function generateLuhnNumber(string $partialValue)
    {
        ...
        return $partialValue . \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Calculator\Luhn::computeCheckDigit($partialValue);
    }
}