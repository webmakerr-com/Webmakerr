...
class Documentor
{
    ...
    public function getFormatters()
    {
        ...
        $providers[] = new \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Provider\Base($this->generator);
        foreach ($providers as $provider) {
            ...
            foreach ($refl->getMethods(\ReflectionMethod::IS_PUBLIC) as $reflmethod) {
                ...
                } elseif ($example instanceof \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\Generator || $example instanceof \FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\FluentCart\Faker\UniqueGenerator) {
                    // modifier
                    $example = '';
                } else {
