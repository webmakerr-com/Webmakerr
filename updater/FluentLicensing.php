...
class FluentLicensing
{
    ...
    private function getExpireMessage($licenseData, $scope = 'global')
    {
        ...
        return '<p>Your ' . $this->getConfig('plugin_title') . ' ' . __('license has been', 'webmakerr') . ' <b>' . __('expired at', 'webmakerr') . ' ' . gmdate('d M Y', strtotime($licenseData['expires'])) . '</b>, Please ' .
            '<a href="' . $renewUrl . '"><b>' . __('Click Here to Renew Your License', 'webmakerr') . '</b></a>' . '</p>';
    }
