...
use FluentEmogrifier\Vendor\Pelago\Emogrifier\Css\CssDocument;
use FluentEmogrifier\Vendor\Pelago\Emogrifier\HtmlProcessor\AbstractHtmlProcessor;
use FluentEmogrifier\Vendor\Pelago\Emogrifier\Utilities\CssConcatenator;
use FluentEmogrifier\Vendor\Symfony\Component\CssSelector\CssSelectorConverter;
use FluentEmogrifier\Vendor\Symfony\Component\CssSelector\Exception\ParseException;
/**
...
class CssInliner extends AbstractHtmlProcessor
{
    ...
    private function logOrThrowPregLastError() : void
    {
        ...
        if ($this->debug) {
            throw new \RuntimeException(esc_html($message), 1592870147);
        }
