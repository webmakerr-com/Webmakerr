...
';
        ...
        $content .= '</office:document-styles>
';
...
';
    ...
    protected function getAutomaticStylesSectionContent($numWorksheets)
    {
        ...
        for ($i = 1; $i <= $numWorksheets; $i++) {
            $content .= '<style:page-layout style:name="pm' . $i . '">
...
';
    ...
    protected function getMasterStylesSectionContent($numWorksheets)
    {
        ...
        for ($i = 1; $i <= $numWorksheets; $i++) {
            $content .= '<style:master-page style:name="mp' . $i . '" style:page-layout-name="pm' . $i . '">
    <style:header/>
...
';
    ...
    public function getContentXmlAutomaticStylesSectionContent($worksheets)
    {
        ...
        $content .= '<style:style style:family="table-column" style:name="co1">
...
';
        ...
        foreach ($worksheets as $worksheet) {
            ...
            $content .= '<style:style style:family="table" style:master-page-name="mp' . $worksheetId . '" style:name="ta' . $worksheetId . '">
