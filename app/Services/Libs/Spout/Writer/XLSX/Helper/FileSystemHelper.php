...
class FileSystemHelper extends \Box\Spout\Common\Helper\FileSystemHelper implements FileSystemWithRootFolderHelperInterface
{
    ...
    {
        $relsFileContents = '<?xml version="1.0" encoding="UTF-8"?>' . "\n" .
    ...
    private function createAppXmlFile()
    {
        ...
        $appXmlFileContents = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' . "\n" .
    ...
    {
        $contentTypesXmlFileContents = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' . "\n" .
        ...
        $contentTypesXmlFileContents .= '    <Override ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.styles+xml" PartName="/xl/styles.xml"/>' . "\n" .
    ...
    {
        $workbookXmlFileContents = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' . "\n" .
        ...
        foreach ($worksheets as $worksheet) {
            ...
            $workbookXmlFileContents .= '        <sheet name="' . $this->escaper->escape($worksheetName) .
                '" sheetId="' . $worksheetId .
                '" r:id="rIdSheet' . $worksheetId .
    ...
    {
        $workbookRelsXmlFileContents = '<?xml version="1.0" encoding="UTF-8"?>' . "\n" .
            '<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">' . "\n" .
