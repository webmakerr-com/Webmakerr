...
class ZipHelper
{
    ...
    {
        global $wp_filesystem;
        $zipContent = $wp_filesystem->get_contents($zipFilePath);
        // Write to the pointer/stream
        // If $pointer is a resource handle, you may need a hybrid approach
        if ($zipContent !== false) {
            //phpcs:ignore WordPress.WP.AlternativeFunctions.file_system_operations_fwrite
            fwrite($pointer, $zipContent);
        }
    }
}
