...
namespace Webmakerr\App\Modules\Coupon;
...
class CouponHandler
{
    ...
    {
        webmakerr_add_filter('webmakerr_cart/payments/apply_coupon', [$this, 'applyCoupon'], 10, 2);
        webmakerr_add_filter('webmakerr_cart/payments/store_applied_coupon_data', [$this, 'storeAppliedCouponData'], 10, 3);
