...
<head>
    ...
    <title>Webmakerr PayPal Authentication</title>
</head>
<body>
<script>
            ...
            <p class="fluent_cart_paypal_authenticator_alert">
                ...
                <?php 
                    echo sprintf(
                        ...
                        esc_html__('Connect URL is not available for order mode %s. Please try again or contact Webmakerr support.', 'webmakerr-cart'),
