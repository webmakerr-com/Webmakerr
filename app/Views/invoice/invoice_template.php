        ...
        <div class="email-template-content" style="max-width: 600px;width: 100%; margin-left: auto; margin-right: auto;">
            <div style="background-color: #fff; border-radius: 8px; ">
                ...
                <div style="padding: 20px;">
                    ...
                    <div class="no-print">
                        <h2 style="margin-top: 0; margin-bottom: 15px; font-size: 20px; font-weight: 600; color: #2F3448;"><?php echo esc_html__('Order Created', 'webmakerr-cart') ?></h2>

                        <p style="font-size: 14px; margin-top: 0; margin-bottom: 4px; color: #2F3448;"><?php echo esc_html__('Hello ', 'webmakerr-cart') ?>
                            {{order.billing.first_name}}!</p>

                        <p style="font-size: 14px; margin: 0; color: #2F3448;">
                            <?php echo esc_html__('Your order ', 'webmakerr-cart') ?>
                            ...
                            <?php echo esc_html__('has been created. Please check the details below', 'webmakerr-cart'); ?>
                        </p>
